...
- It save the auc e roc curves and confusion matrix for each class for classification tasks.
- It saves the regression metrics (MSE, MAE, R2) for regression tasks.
- It saves the predictions and labels for each head in a dictionary and plots the true vs predicted distributions.
- 
